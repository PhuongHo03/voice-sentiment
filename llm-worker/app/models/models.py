...
class AnalysisResultModel(Base):
    ...
    detailed_summary_json: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
    agent_score_breakdown_json: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
    quality_notes_json: Mapped[list | None] = mapped_column(JSONB, nullable=True)
    analysis_metadata_json: Mapped[dict | None] = mapped_column(JSONB, nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now())
